...
export class BookEntity extends Entity<BookProperties> {
  ...
  static create(props: PartialBy<BookProperties, "id" | "book_id" | "created_at" | "updated_at" | "search_vector">) {
    const now = new Date();
    ...
    return new BookEntity({
      ...
      created_at: now,
      updated_at: now,
      search_vector: undefined, // Will be auto-generated by trigger
      ...props,
    });
  }
